...
@WebServlet(urlPatterns = {"/lastconnect2"})
public class lastconnect2 extends HttpServlet {
       ...
       PrintWriter out=response.getWriter();
        ...
        if(session!=null){
            ...
            try{
                ...
                ResultSet rs = (ResultSet) st.executeQuery("SELECT * FROM manager WHERE email='"+email+"'" );
                if(rs.next()){
