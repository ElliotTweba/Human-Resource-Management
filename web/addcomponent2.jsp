...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#component').show();
		$('.component2 li:first-child a').addClass('active');
		$('.component2 li a').click(function(e) {

			var tabDiv = this.hash;
			$('.component2 li a').removeClass('active');
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addcomponent">Click Here To Add Salary Component</a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addcomponent" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitcomponent2.jsp"
                                          method="post">
