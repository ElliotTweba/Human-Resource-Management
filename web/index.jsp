...
<body>
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="panel panel-default login">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal center-block" method="post" action="./Conn" ><br>
                            <div></div>
                            ...
                            <div class="links">
                                <a href="index.jsp">User</a> || <a href="manager.jsp">Manager</a>|| <a href="">Admin</a>
                            </div>
                        </form>
                    </div><BR><BR>
                </div>
        ...
        <div class="row footer navbar-fixed-bottom">
            <div class="col-md-12">
                <p>Copyrights © HR System 2018. All rights reserved. Design by:- Tsekiso</p>
            </div>
        </div<br><br>
    </div>
