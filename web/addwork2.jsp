...
<script type="text/javascript">
    $(document).ready(function() {
        $('#work').show();
        $('.work2 li:first-child a').addClass('active');
        $('.work2 li a').click(function(e) {
            var tabDiv = this.hash;
            $('.work2 li a').removeClass('active');
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Add Week Work</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addwork">Click Here To Add Week Work</a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addwork" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitwork2.jsp"
                                          method="post">
