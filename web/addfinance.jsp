...
<script type="text/javascript">
    $(document).ready(function() {
        $('#finance').show();
        $('.finance li:first-child a').addClass('active');
        $('.finance li a').click(function(e) {
            var tabDiv = this.hash;
            $('.finance li a').removeClass('active');
                    ...
                    <div class="panel-body">
                        ...
                        <div id="addfinance" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitsalary.jsp"
                                          method="post">
