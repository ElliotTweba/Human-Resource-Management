...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#compony').show();
		$('.compony2 li:first-child a').addClass('active');
		$('.compony2 li a').click(function(e) {

			var tabDiv = this.hash;
			$('.compony2 li a').removeClass('active');
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Add Compony Information</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addcompony">Click HereTo Add Information </a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addcompony" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitcomp2.jsp"
                                          method="post">
