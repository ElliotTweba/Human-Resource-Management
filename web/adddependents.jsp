...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#dependent').show();
		$('.dependent2 li:first-child a').addClass('active');
		$('.dependent2 li a').click(function(e) {
			var tabDiv = this.hash;
			$('.dependent2 li a').removeClass('active');
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Add Dependents Information</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#adddependent">Click HereTo Add Dependents </a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="adddependent" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitdep.jsp"
                                          method="post">
