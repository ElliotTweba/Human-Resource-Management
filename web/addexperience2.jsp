...
<script type="text/javascript">
    $(document).ready(function() {
        $('#experience').show();
        $('.experience2 li:first-child a').addClass('active');
        $('.experience2 li a').click(function(e) {
            var tabDiv = this.hash;
            $('.experience2 li a').removeClass('active');
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Add Employee Experience</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addexperience">Click HereTo Add Experience </a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addexperience" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitexp2.jsp"
                                          method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Employee Position</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="position" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Last Occupation</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="occupation" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Worked Duration</label>
                                            <div class="col-sm-4">
