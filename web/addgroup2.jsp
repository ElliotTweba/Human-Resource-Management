                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addgroup">Click Here To Add Group Leave</a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addgroup" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitgroup2.jsp"
                                          method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Leave Group</label>
                                            <div class="col-sm-4">
