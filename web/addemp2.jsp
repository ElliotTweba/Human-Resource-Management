...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#emp').show();
		$('.emp2 li:first-child a').addClass('active');
		$('.emp2 li a').click(function(e) {
			var tabDiv = this.hash;
			$('.emp2 li a').removeClass('active');
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addemp">Click HereTo Add Employee </a>
                            </li>
                        </ul>
                        ...
                        <div id="addemp" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitemp2.jsp"
                                          method="post">
