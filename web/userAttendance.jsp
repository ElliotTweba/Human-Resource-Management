        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">User Attendance</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs attend">
                            <li role="presentation"><a href="#attendlist">Attendance List </a></li>
                            <li role="presentation"><a href="#timein">Punch Time-in </a></li>
