...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#addemp').show();
		$('.dep li:first-child a').addClass('active');
		$('.dep li a').click(function(e) {

			var tabDiv = this.hash;
			$('.dep li a').removeClass('active');
        ...
        <div class="col-md-10 maincontent">
            ...
            <div class="panel panel-default contentinside">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs dep">
                        <li role="presentation"><a href="#addemp">Click Here
                                To Edit Employee Information</a>
                        </li>
                    </ul>
                    <!----------------   Edit Department Start   --------------->
                    <div id="addemp" class="switchgroup">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form class="form-horizontal" action="updateuser.jsp"
                                      method="post">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Employee Email</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Employee Level</label>
                                        <div class="col-sm-4">
