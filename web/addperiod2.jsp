...
<script type="text/javascript">
    $(document).ready(function() {
        $('#period').show();
        $('.period2 li:first-child a').addClass('active');
        $('.period2 li a').click(function(e) {
            var tabDiv = this.hash;
            $('.period2 li a').removeClass('active');
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Add Leave Period</div>
                    <!----------------   Panel Body Start   --------------->
                    <div class="panel-body">
                        <ul class="nav nav-tabs doctor">
                            <li role="presentation">
                                <a href="#addperiod">Click Here To Add Leave Period</a>
                            </li>
                        </ul>
                        <!----------------   Edit Department Start   --------------->
                        <div id="addperiod" class="switchgroup">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" action="submitperiod2.jsp"
                                          method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Leave Period</label>
                                            <div class="col-sm-4">
